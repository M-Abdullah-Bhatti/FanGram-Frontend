...
function CTA() {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row bg-[#FCAE4B] bg-[`/images/background.png`] min-h-[350px] py-4 lg:py-12 px-4 lg:px-0" style={divStyle}>
        <div className='text-center md:text-left w-full md:w-2/3 p-4 md:p-10 space-y-2 md:space-y-8'>
          ...
          <button className='bg-white text-[#D42978] text-sm md:text-xl px-4 py-2 rounded-3xl'>Fill The Form</button>
        </div>
