...
function FanrangBusiness() {
  return (
    <div className="w-full mt-6">
      <h2 className="font-semibold text-xl md:text-3xl lg:text-[45px] text-left md:text-center mb-2 md:mb-16">
      ...
      {/* Dividing Line */}
      <p className="text-center underline text-sm md:text-2xl text-[#D84388] my-6 cursor-pointer">
