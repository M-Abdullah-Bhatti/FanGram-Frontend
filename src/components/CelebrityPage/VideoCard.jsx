...
function VideoCard({celebrity}) {
  ...
  return (
    <div className="min-w-[275px] relative">
      {openVideoModal && (
        <VideoPlayerModal
      ...
      <div className="absolute bottom-0 left-0 right-0 p-2 space-y-2">
        ...
        <p className="text-sm">{celebrity.tagline}</p>
      </div>
    </div>
  );
}
