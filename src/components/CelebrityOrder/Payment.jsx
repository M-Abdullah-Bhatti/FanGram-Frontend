    ...
    <div className="mt-12 md:mt-24 lg:mx-32">
        <div className="bg-white rounded-t-3xl">
            <div className="px-6 py-2 pt-6">
                <h3 className='mb-3 text-[#7E7E7E] font-semibold text-sm md:text-base'>Your Cart</h3>
                <div className="flex gap-2">
                    ...
                    <div>
                        ...
                        <span className="flex gap-2 text-[#D42978]">
                            <span className="flex gap-1 md:gap-2 text-sm md:text-base text-[#D42978] cursor-pointer">Show/Edit</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer w-[14px] md:w-[22px]" viewBox="0 0 22 22" fill="none">
