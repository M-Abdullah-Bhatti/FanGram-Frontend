    ...
    <div className="mt-12 md:mt-24 lg:mx-32">
        <div className="bg-white rounded-t-2xl md:rounded-t-3xl">
            ...
            <div className='flex flex-col lg:flex-row items-center justify-between my-4 gap-2 px-6'>
              ...
              <button className='w-full md:w-[50%] lg:w-[25%] bg-[#D84388] text-white text-sm lg:text-xl rounded-3xl px-4 py-3 md:mb-1 mt-2 md:mt-0' onClick={()=> setCurrentIndex(2)}>Proceed To Pay</button>
            </div>
            
            <div className='w-full flex overflow-hidden'>
              {
                  [1, 2, 3, 4].map((index)=> (
                    <img src="/images/Vector.svg" alt="" className="w-full bg-black" key={index} />
                  ))
              }
            </div>
        </div>
