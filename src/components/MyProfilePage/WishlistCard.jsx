    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-center">
          <p className="font-satisfy text-xl text-white font-normal">#{celebrity.tags[0]}</p>
          <button className="bg-white text-[#D42978] px-4 py-1 rounded-full text-lg font-medium" onClick={handleFavoriteClick}>
            Remove
          </button>
        </div>
      </div>
